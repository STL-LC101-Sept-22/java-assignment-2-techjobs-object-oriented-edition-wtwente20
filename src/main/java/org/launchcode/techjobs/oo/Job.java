...
public class Job {
    ...
    @Override
    public String toString() { // The string should contain a label for each field, followed by the data stored in that field. Each field should be on its own line.
